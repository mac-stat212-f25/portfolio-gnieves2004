...
ggplot(aes(x = dateInYear), data = weather) +
  geom_ribbon(aes(ymin = RecordLow, ymax = RecordHigh), fill = "#ECEBE3") +
    theme_classic()
```
...
ggplot(aes(x = date), data = weather) +
  geom_ribbon(aes(ymin = RecordLow, ymax = RecordHigh), fill = "#ECEBE3") +
  geom_ribbon(aes(ymin = NormalLow, ymax = NormalHigh), fill = "#C8B8BA")+
  geom_ribbon(aes(ymin = Low, ymax = High), fill = "#A90248")+
  scale_x_date(date_labels = "%b", breaks = seq(
    from = as.Date("2011-01-15"),
    to = as.Date("2011-12-15"),
    by = "1 month"
  )
  ) +
  geom_vline(xintercept = as.Date("2011-01-01"), color = "grey", linetype = "dashed") +
  geom_vline(xintercept = as.Date("2011-02-01"), color = "grey", linetype = "dashed") +
  geom_vline(xintercept = as.Date("2011-03-01"), color = "grey", linetype = "dashed") +
  geom_vline(xintercept = as.Date("2011-04-01"), color = "grey", linetype = "dashed") +
  geom_vline(xintercept = as.Date("2011-05-01"), color = "grey", linetype = "dashed") +
  geom_vline(xintercept = as.Date("2011-06-01"), color = "grey", linetype = "dashed") +
  geom_vline(xintercept = as.Date("2011-07-01"), color = "grey", linetype = "dashed") +
  geom_vline(xintercept = as.Date("2011-08-01"), color = "grey", linetype = "dashed") +
  geom_vline(xintercept = as.Date("2011-09-01"), color = "grey", linetype = "dashed") +
  geom_vline(xintercept = as.Date("2011-10-01"), color = "grey", linetype = "dashed") +
  geom_vline(xintercept = as.Date("2011-11-01"), color = "grey", linetype = "dashed") +
  geom_vline(xintercept = as.Date("2011-12-01"), color = "grey", linetype = "dashed") +
  theme_classic()
...
weather %>%
  ...
  geom_text(data = weather_culmprec, aes(label = CulmPrec), vjust = -.5, size = 3)+
  geom_point(data = weather_p, aes(label = RecordP), shape = 17) +
  theme_classic()
```
## Done!
